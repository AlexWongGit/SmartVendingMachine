...
public class BrokerConfig {
    ...
    private String jmqttHome = System.getenv("VM_HOME") != null ? System.getenv("VM_HOME") : System.getProperty("user.dir") +
            File.separator + "vm-broker" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "conf";
